...
| [`io.md`](io.md) | `Nordstein.Core.Common.Io` — durable atomic file publishing (`IDurableFilePublisher`) and mode-checked secret-file loading (`ISecretFileLoader`), with the durability scope and the Windows degrade story. |
