...
/// stored entities marked with <see cref="CacheableAttribute"/> — a cached domain entity holds the
...
/// the root-scope copy that singleton services (e.g. an ingestion executor) read through.
///
...
/// </summary>
public interface IEntityCache<TDomainEntity> where TDomainEntity : IDomainEntity
{
