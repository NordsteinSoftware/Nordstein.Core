...
internal sealed class Transaction : ITransaction
{
    ...
    public Transaction(Func<DbContext> contextFactory, AmbientDbContext ambient)
    {
    ...
    public async Task<TResult> InvokeAsync<TResult>(Func<Task<TResult>> operation, CancellationToken cancellationToken = default)
    {
        ...
        DbContext context = contextFactory();
        IDbContextTransaction efTransaction = await context.Database.BeginTransactionAsync(cancellationToken);
