...
/// <summary>
/// Generates a throwaway keypair and signs license JWTs with it, so engine tests run against a
/// key they control. Defaults to ES256 (P-256); pass <c>useEcdsa: false</c> to exercise the
/// legacy RS256 path.
/// </summary>
internal sealed class TestLicenseFactory : IDisposable
{
    public const string Issuer = "https://license.example.com";
    public const string Audience = "example-product";
    ...
    public string CreateJwt(
        string tier = TestTierPolicy.Premium,
        ...
        bool sign = true)
    {
        ...
        // Emitted as a real JSON boolean (ClaimValueTypes.Boolean) to mirror a license server's
