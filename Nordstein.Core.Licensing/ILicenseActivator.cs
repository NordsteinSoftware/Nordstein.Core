...
/// in the consuming product; this interface only covers validation and activation.
/// </summary>
public interface ILicenseActivator
{
    ...
    /// <summary>
    /// Like <see cref="Activate"/>, but never throws: a rejected JWT activates a fallback-tier
    ...
    /// or the fallback tier) and makes it active. Used when a stored license is removed. Never
    /// throws — an invalid configured JWT yields <see cref="LicenseStatus.Invalid"/> with
    /// fallback-tier entitlements.
    /// </summary>
